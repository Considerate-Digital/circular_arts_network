...
<div class="can-bs-wrapper">
	<div class="can-login-wrap">
		...
		<form action="#" method="post" class="can-login-form mt-3">
            <input type="hidden" value="circartsnet_seller_login" name="action">  
            ...
            <?php if (circartsnet_get_option('captcha_on_login') == 'on') { ?>
        ...
        <p class="text-center mb-0 mt-2">
        	...
        	<a class="can-register-link" href="<?php echo esc_url( add_query_arg( 'circartsnet_page', 'register') ); ?>"><?php esc_html_e( 'Register Now', 'circular-arts-network' ); ?></a>
        </p>
	</div>
</div>
