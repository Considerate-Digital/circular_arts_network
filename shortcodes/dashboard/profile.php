...
<div class="can-screen-wrapper">
	<div class="can-screen-header">
		<?php esc_html_e( 'Edit Profile', 'circular-arts-network' ) ?>
	</div>
				...
				<div class="col">
					<div class="can-pic-wrap">
						...
						<a href="#" class="can-upload-btn"
							data-title="<?php esc_html_e( 'Choose Image for Profile Picture', 'circular-arts-network' ); ?>"
							data-btntext="<?php esc_html_e( 'Set Profile', 'circular-arts-network' ); ?>"
							>
