...
<div class="can-screen-wrapper">
	<div class="can-screen-header">
		<?phpesc_html_e( 'Edit Profile', 'circular-arts-network' ) ?>
	</div>
			...
			<div class="row">
				<div class="col">
					<div class="can-pic-wrap">
						...
						<a href="#" class="can-upload-btn"
							data-title="<?phpesc_html_e( 'Choose Image for Profile Picture', 'circular-arts-network' ); ?>"
							data-btntext="<?phpesc_html_e( 'Set Profile', 'circular-arts-network' ); ?>"
							>
				...
				<div class="col">
					...
					<div class="text-end px-2">
						<input class="btn btn-success" type="submit" value="<?phpesc_html_e( 'Update Profile', 'circular-arts-network' ); ?>">
					</div>
				</div>
			</div>
