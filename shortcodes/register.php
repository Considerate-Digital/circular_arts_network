<div class="can-bs-wrapper">
	<div class="can-login-wrap">
		<h2><?phpesc_html_e( 'Register', 'circular-arts-network' ); ?></h2>

		<form action="#" method="post" class="can-register-form mt-3">
            <div class="form-group can-input-wrapper">
                <label><?phpesc_html_e( 'First Name', 'circular-arts-network' ); ?></label>
                <input type="text" name="first_name" class="can-text-input" required>
            </div>
            <div class="form-group can-input-wrapper">
                <label><?phpesc_html_e( 'Last Name', 'circular-arts-network' ); ?></label>
                <input type="text" name="last_name" class="can-text-input" required>
            </div>
            <div class="form-group can-input-wrapper">
                <label><?phpesc_html_e( 'Username', 'circular-arts-network' ); ?></label>
            ...
            <div class="form-group can-input-wrapper">
                <label><?phpesc_html_e( 'Phone', 'circular-arts-network' ); ?></label>
            ...
            <div class="form-group can-input-wrapper">
                <label><?phpesc_html_e( 'Confirm Password', 'circular-arts-network' ); ?></label>
            ...
            <div class="form-group can-input-wrapper can-upload-picture">
              <label for="sellerImage"><?phpesc_html_e( 'Profile Picture', 'circular-arts-network' ); ?></label>
            ...
            <?php } ?>
            <div class="form-group">
                <button type="submit" class="can-btn"><?phpesc_html_e( 'Register Now', 'circular-arts-network' ); ?></button>
            </div>
        </form>
        <p class="text-center mb-0 mt-2">
        	<?phpesc_html_e( "Already have an account?", 'circular-arts-network' ); ?>
        	<a class="can-register-link" href="<?php echo esc_url( remove_query_arg( 'can_page' ) ); ?>"><?phpesc_html_e( 'Sign In', 'circular-arts-network' ); ?></a>
        </p>
	</div>
</div>