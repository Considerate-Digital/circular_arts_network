		...
		<div class="col-sm-9">
			<form id="can-settings-form" class="form-horizontal">
				...
				<div class="text-right mt-2">
					<span class="wcp-progress" style="display:none;"><?php esc_html_e( 'Please Wait...', 'circular-arts-network' ); ?></span>					
					<input class="btn btn-success float-end" type="submit" value="<?php esc_html_e( 'Save Settings', 'circular-arts-network' ); ?>">
				</div>
